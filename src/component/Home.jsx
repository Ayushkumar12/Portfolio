...
import cv from "../asserts/cv/updated CV.pdf";
  ...
  return (
    <main className="background1" data-aos="fade-up">
      <Helmet>
        ...
        <meta name="twitter:image" content={Ayush1} />
        <meta name="twitter:site" content="@Ayush" />
      ...
      <div className="about">
        ...
        <p>
          I am Ayush Kumar, a passionate web developer with a strong foundation
          in HTML, CSS, and React JS. During my studies, I honed my skills in
          front-end development, building interactive websites and web
          applications using the latest React.js technologies. I am adept at
          collaborating with teams to create user-friendly, responsive designs
          that deliver an optimal experience across devices.
        </p>
        <a href={cv} className='button'>Download CV</a>
      </div>
      <div className="skill">
        <div className="title">
          <h1>Skills</h1>
